  ...
  <body>
    ...
    <?php endif; ?>
            ...
            <div class="ms-3 d-flex align-items-center">
              ...
              <a href="cart.html" class="btn btn-primary ms-2">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 hero-image">
            <img
              src="https://cdn.hstatic.net/products/200000547251/prm_bc0ef882cc134409b68e13d4dfb7c6cb_master.jpg"
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card product-card h-100">
              ...
              <div class="card-body">
                ...
                >
                  <h5 class="card-title mb-0">Smartphone Model X</h5>
                  <div class="price">
                ...
                <p class="card-text">
                  Flagship mới nhất với màn hình 120Hz và hệ thống camera ba ống
                  kính.
                </p>
              </div>
            ...
            <div class="card product-card h-100">
              ...
              <div class="card-body">
                <div
                  class="d-flex justify-content-between align-items-start mb-2"
                >
                  <h5 class="card-title mb-0">Wireless Earbuds Pro</h5>
                  <div class="price">
                ...
                <p class="card-text">
                  Hủy tiếng ồn chủ động với thời lượng pin 24 giờ.
                </p>
              </div>
              <div class="card-footer bg-transparent">
                <button class="btn btn-primary w-100">Thêm vào Giỏ hàng</button>
            ...
            <div class="card product-card h-100">
              ...
              <div class="card-body">
                <div
                  class="d-flex justify-content-between align-items-start mb-2"
                >
                  <h5 class="card-title mb-0">Smart Watch Series 5</h5>
                  <div class="price">
                ...
                <div class="ratings mb-2">
                  ...
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <span class="ms-1">(214)</span>
                </div>
                <p class="card-text">
                  Giám sát sức khỏe và màn hình retina luôn bật.
                </p>
              </div>
              <div class="card-footer bg-transparent">
                <button class="btn btn-primary w-100">Thêm vào Giỏ hàng</button>
            ...
            <div class="card product-card h-100">
              ...
              <div class="card-body">
                <div
                  class="d-flex justify-content-between align-items-start mb-2"
                >
                  <h5 class="card-title mb-0">Fast Wireless Charger</h5>
                  <div class="price">
                ...
                <p class="card-text">
                  Sạc nhanh 15W tương thích với tất cả thiết bị Qi.
                </p>
              </div>
              <div class="card-footer bg-transparent">
                <button class="btn btn-primary w-100">Thêm vào Giỏ hàng</button>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-card text-center p-4">
              ...
              <p>
                Giao hàng miễn phí cho tất cả đơn hàng trên 50 USD với thời gian
          ...
          <div class="col-md-4">
            <div class="testimonial-card p-4">
              ...
              <p class="testimonial-text mb-4">
                "Điện thoại tôi mua từ Mobile Hub chính xác như mô tả và đến sớm
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-8">
            ...
            <p class="lead mb-0">
              Tham gia hàng nghìn khách hàng hài lòng tin tưởng Mobile Hub cho
            ...
            <div class="contact-info p-4 h-100">
              ...
              <ul class="list-unstyled">
                <li class="mb-3">
                  ...
                  <span>123 Đường Công nghệ, Thung lũng Silicon, CA 94025</span>
                </li>
                <li class="mb-3">
